...
public class Aura extends Module {
    ...
    private void renderWraith(Entity target) {
        if (target instanceof LivingEntity living) {
            Render3DEngine.renderGhostsV2(wraithLength.getValue(), wraithFactor.getValue(), wraithShaking.getValue(), wraithAmplitude.getValue(), living);
        }
    }
    ...
    public enum ESP {
        Off, ThunderHack, NurikZapen, CelkaPasta, ThunderHackV2, Orbit, Spectre, Wraith
    }
