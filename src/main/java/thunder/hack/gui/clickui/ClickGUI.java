...
public class ClickGUI extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (!Objects.equals(currentDescription, "") && ModuleManager.clickGui.descriptions.getValue()) {
            ...
            float tx = mouseX + 9;
            float ty = mouseY + 6;
            Render2DEngine.drawRoundedRect(context.getMatrices(), tx, ty, tw, th, 3f, new java.awt.Color(16, 16, 20, 220));
            Render2DEngine.drawRoundedOutline(context.getMatrices(), tx, ty, tw, th, 3f, 0.6f, new java.awt.Color(255, 255, 255, 20));
